...
<div class="container">
	<h1>자료실 글 수정하기</h1>																	<!--  파일업로일경우 반드시 enctype속성이 필요하다 -->
	<form method="post" action="<%=request.getContextPath()%>/data/dataEditOk.do" id="dataFrm" enctype="multipart/form-data">
		<input type='hidden' name="no" value="${vo.no}">	
		<ul>
			<li>제목 : <input type="text" name="title" id="title" size="50" placeholder="글제목" value="${vo.title}"></li>
			<li>
			...
			<li>첨부파일 : <br> 
				...
				<input type="hidden" name="" id="delfile1" value="${vo.filename1}"> <!-- 삭제될 파일명일위한 박스 -->
			</li>
